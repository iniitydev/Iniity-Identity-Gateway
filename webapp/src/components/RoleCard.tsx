...
export const RoleCard: React.FC<Role> = ({ title, system, function: func, strength, details, color }) => {
  return (
    <div className={`bg-gray-900/50 rounded-lg shadow-lg overflow-hidden border-t-4 ${color} flex flex-col`}>
      <div className="p-6 flex-grow">
        ...
        <h4 className="text-2xl font-bold text-white mt-1">{system}</h4>
        <p className="mt-2 text-gray-400">{func}</p>
